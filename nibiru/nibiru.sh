...
echo -e "\033[0;31m Install Cosmovisor\033[0m"
go install github.com/cosmos/cosmos-sdk/cosmovisor/cmd/cosmovisor@v1.0.0

echo -e "\033[0;31m Configuring Cosmovisor\033[0m"
...
echo -e "\033[0;31m Updating configs\033[0m"

echo -e "\033[0;31m Update node config\033[0m"
...
echo -e "\033[0;31m Update Filebeat config\033[0m"
echo "  - type: log
    format: auto
    paths:
      - /var/log/node-nibiru
